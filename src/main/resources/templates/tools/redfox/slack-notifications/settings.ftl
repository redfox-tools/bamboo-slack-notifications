...
<form id="slackSettings" method="post" class="aui">
    ...
    [#if jira?? ]
        [@ui.bambooSection title="Jira integration" description="Enable custom Jira integration for Slack notifications"]
            <p>Looks like you have active link between Jira and Bamboo. This slack integration can obtain detailed
                information
                about detected tasks, but to do so you need to select username which has been already authenticated with
                Jira.</p>
            <div class="field-group required">
                [@ww.select label="Username" name="slackJiraBambooUsername" list=users class="long-field"/]
            </div>
        [/@ui.bambooSection]
    [/#if]
...
[#if !slackOAuthBot?? ]
    ...
    [@ui.bambooSection title="How to configure your Slack workspace"]
        <div class="aui-message info">
            ...
            <ul>
                <li>Slack is deprecating legacy incoming webhooks (<a
                            href="https://api.slack.com/custom-integrations/incoming-webhooks">more</a>)
                </li>
                <li>This integration is using chat <a href="https://api.slack.com/methods">API methods</a> for
                    interactive messages
                </li>
                <li>Future versions of the application will include <a href="https://api.slack.com/slash-commands">slash
                        commands</a></li>
            </ul>
        ...
        <p>Go to <a href="https://api.slack.com/apps?new_app=1">https://api.slack.com/apps?new_app=1</a> and fill the
            form</p>
